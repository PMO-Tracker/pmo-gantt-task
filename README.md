# PMO Gantt Task (PMO-GANTT-TASK)

## 📋 Overview
**PMO Gantt Task** is a React-based web application with an interactive Gantt chart that displays tasks in a grid across various view scales. It supports dynamic interactions, enabling efficient task management and progress tracking.

---

## 🛠️ Tech Stack

- **Core Libraries**: React (v18), React-DOM
- **Testing**: 
  - Jest (@types/jest, @testing-library/jest-dom)
  - React Testing Library (@testing-library/react, @testing-library/user-event)
- **Type Checking**: TypeScript (@types/react, @types/react-dom, @types/node)
...
1. **Clone the repository**:
   ```bash
   git@github.com:PMO-Tracker/pmo-gantt-task.git
   cd pmo-gantt-task
